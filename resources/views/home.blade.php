        ...
        <div class="row">
            ...
            <div class="col-md-2 mb-5">
                <div class="bg-white text-center py-3  rounded-xl">
                    ...
                    <a href="javascript::void(0);" class="font-weight-bolder font-size-h7 mt-2">Purchase</a>
                </div>
            </div>
            ...
            <div class="col-md-2 mb-5">
                <div class="bg-white text-center py-3  rounded-xl">
                    ...
                    <a href="javascript::void(0);" class="font-weight-bolder font-size-h7 mt-2">Sale</a>
                </div>
            </div>
            ...
            <div class="col-md-2 mb-5">
                <div class="bg-white text-center py-3  rounded-xl">
                    ...
                    <a href="javascript::void(0);" class="font-weight-bolder font-size-h7 mt-2">Income</a>
                </div>
            </div>
            ...
            <div class="col-md-2 mb-5">
                <div class="bg-white text-center py-3  rounded-xl">
                    ...
                    <a href="javascript::void(0);" class="font-weight-bolder font-size-h7 mt-2">Expense</a>
                </div>
            </div>
            ...
            <div class="col-md-2 mb-5">
                <div class="bg-white text-center py-3  rounded-xl">
                    ...
                    <a href="javascript::void(0);" class="font-weight-bolder font-size-h7 mt-2">Supplier Due</a>
                </div>
            </div>
            ...
            <div class="col-md-2 mb-5">
                <div class="bg-white text-center py-3  rounded-xl">
                    ...
                    <a href="javascript::void(0);" class="font-weight-bolder font-size-h7 mt-2">Customer Due</a>
                </div>
            </div>
