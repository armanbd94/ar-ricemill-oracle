        ...
        if($request->ajax()){
            if (permission('general-setting-access')) {
                ...
                if($request->hasFile('logo')){
                    $logo    = $this->upload_file($request->file('logo'),LOGO_PATH,$file_name='site-logo','public');
                ...
                if($request->hasFile('favicon')){
                    $favicon    = $this->upload_file($request->file('favicon'),LOGO_PATH,$file_name='site-favicon','public');
