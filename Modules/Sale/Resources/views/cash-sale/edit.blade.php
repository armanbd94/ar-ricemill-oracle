                                    ...
                                    <tbody>
                                        @if(!$sale->products->isEmpty())
                                            ...
                                            <tr>
                                                ...
                                                <td >                                                  
                                                    <select name="products[{{ $key+1 }}][location_id]"   onchange="product_list({{ $key+1 }})" id="products_{{ $key+1 }}_location_id" class="fcs col-md-12 location_id form-control "  data-live-search="true" data-row="{{ $key+1 }}">                                            
                                                        <option value="">Select Please</option>  
