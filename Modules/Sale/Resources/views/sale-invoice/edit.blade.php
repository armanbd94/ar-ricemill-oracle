                                ...
                                <table class="table table-bordered" id="product_table">
                                    ...
                                    <tbody>
                                        @if (!$invoice->products->isEmpty())
                                            ...
                                            <tr>
                                                <td>                     
                                                    <select name="products[{{ $key + 1 }}][id]" id="products_{{ $key + 1 }}_id"  class="fcs col-md-12 form-control " onchange="setProductDetails({{ $key + 1 }})"  data-live-search="true" data-row="{{ $key + 1 }}">    
                                                ...
                                                <td>                                                  
                                                    <select name="products[{{ $key + 1 }}][site_id]"  id="products_{{ $key + 1 }}_site_id" class="fcs col-md-12 site_id form-control " onchange="getLocations(this.value,{{ $key + 1 }})"  data-live-search="true" data-row="{{ $key + 1 }}">                                            
                                                        <option value="">Select Please</option>  
                                                        @if(!$sites->isEmpty())  
                                                ...
                                                <td>                                                  
                                                    <select name="products[{{ $key + 1 }}][location_id]"  onchange="product_stock_qty({{ $key + 1 }})" id="products_{{ $key + 1 }}_location_id" class="fcs col-md-12 location_id form-control "  data-live-search="true" data-row="{{ $key + 1 }}">                                            
                                                        <option value="">Select Please</option>  
                                                ...
                                                <td style="width:250px;">
                                                    <select name="products[{{ $key + 1 }}][item_class_id]" style="width:250px;" id="products_{{ $key + 1 }}_item_class_id" class="fcs col-md-12 form-control " data-live-search="true" data-row="{{ $key + 1 }}">    
                                                        <option value="">Select Please</option>                                        
                                                        @if (!$classes->isEmpty())
