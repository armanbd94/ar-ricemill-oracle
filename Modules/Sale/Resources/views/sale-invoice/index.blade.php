        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    ...
                    <a href="{{ route('sale.invoice.form') }}"  class="btn btn-primary btn-sm font-weight-bolder custom-btn"> 
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('sale.invoice.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
        ...
        "columnDefs": [{
            ...
            {
                @if (permission('sale-invoice-bulk-delete'))
                "targets": [1,2,3,4,5,6,7,9,10,12,13,14],
                @else
                "targets": [0,1,2,3,4,5,6,8,9,11,12,13],
                @endif
                "className": "text-center"
            },
            {
        ...
        "buttons": [
            ...
            },
            {
                ...
                "exportOptions": {
                    @if (permission('sale-invoice-bulk-delete'))
                    columns: ':visible:not(:eq(0),:eq(15))' 
                    @else
                    columns: ':visible:not(:eq(14))' 
                    @endif
                },
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('sale.invoice.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('sale.invoice.bulk.delete')}}";
