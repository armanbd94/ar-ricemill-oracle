        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    ...
                    <a href="{{ route('bom.re.packing.create') }}"  class="btn btn-primary btn-sm font-weight-bolder custom-btn"> 
                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th>Sl</th>
                                        <th>Memo No.</th>
                                        <th>Converted From Product</th>
                                        <th>From Site</th>
                                        <th>From Location</th>
                                        <th>Converted to Product</th>
                                        <th>To Site</th>
                                        <th>To Location</th>
                                        <th>Converted Qty</th>
                                        <th>Bag</th>
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('bom.re.packing.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('bom.re.packing.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('bom.re.packing.bulk.delete')}}";
