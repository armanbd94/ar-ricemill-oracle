        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    ...
                    <a href="{{ route('bom.re.process.create') }}"  class="btn btn-primary btn-sm font-weight-bolder custom-btn"> 
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('bom.re.process.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
                data.process_type = 2;
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('bom.re.process.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('bom.re.process.bulk.delete')}}";
