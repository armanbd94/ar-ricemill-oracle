        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    <!--begin::Button-->
                    <a  href="{{ route('bom.re.process') }}" class="btn btn-danger btn-sm mr-3 custom-btn"><i class="fas fa-window-close"></i> Cancel</a>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="per_unit_cost" id="per_unit_cost" value="{{ $data->per_unit_cost }}"  class="form-control text-right bg-secondary" readonly></td>
                                                    <td></td>
                                                </tr>
                                            </tbody>
                                        </table>
...
function store_data(){
    ...
    let url = "{{route('bom.re.process.update')}}";
    $.ajax({
        url: url,
        type: "POST",
        data: formData,
        ...
        success: function (data) {
            ...
            if (data.status == false) {
                ...
                if (data.status == 'success') {
                    window.location.replace("{{ url('bom/re-process') }}");
                }
            }
