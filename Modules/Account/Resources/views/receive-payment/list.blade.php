        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    <!--begin::Button-->
                    @if (permission('receive-payment-add'))
                    <a href="{{ route('receive.payment.create') }}"  class="btn btn-primary btn-sm font-weight-bolder custom-btn"> 
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="Customer" name="customer_coa_id" required="required"  col="col-md-3" class="selectpicker">
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('receive.payment.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('receive.payment.delete') }}";
