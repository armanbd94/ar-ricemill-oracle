        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    <!--begin::Button-->
                    <a href="{{ route('build.disassembly') }}" class="btn btn-warning btn-sm font-weight-bolder"> 
                ...
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <form action="" id="purchase_store_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <x-form.textbox labelName="Date" name="transfer_date" value="{{ date('Y-m-d') }}" required="required" class="date" col="col-md-4"/>

                            <x-form.textbox labelName="Finish Goods" name="from_location" required="required"  col="col-md-4"/>

                            <x-form.textbox labelName="From Location" name="from_location" required="required"  col="col-md-4"/>
                            
                            <x-form.textbox labelName="To Location (Storage)" name="to_location" required="required"  col="col-md-4"/>

                            {{-- <x-form.selectbox labelName="Raw Material Item" name="via_vendor_id" col="col-md-3" class="selectpicker">
                                    ...
                                    <div class="col-md-12 pt-5 material_section">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="fine_rice_qty text-center" id="fine_rice_qty" class="form-control"></td>
                                                    <td><input type="text" name="fine_rice_qty text-center" id="fine_rice_qty" class="form-control"></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        {{-- <div class="row">
                                            <div class="form-group col-md-3 required">
                                                <label for="fine_rice_qty" class="form-control-label">Raw Material Item</label>
                                                <input type="text" name="fine_rice_qty" id="fine_rice_qty" class="form-control">
                                            </div>
                                            <div class="form-group col-md-2 required">
                                                <label for="rice_convertion_ratio" class="form-control-label">Stock Out Qty</label>
                                                <input type="text" name="rice_convertion_ratio" id="rice_convertion_ratio" class="form-control">
                                            </div>
                                            <div class="form-group col-md-2 required">
                                                <label for="rice_convertion_ratio" class="form-control-label">Used Qty</label>
                                                <input type="text" name="rice_convertion_ratio" id="rice_convertion_ratio" class="form-control">
                                            </div>
                                            <div class="form-group col-md-2 required">
                                                <label for="rice_convertion_ratio" class="form-control-label">Used Qty</label>
                                            ...
                                            <div class="form-group col-md-2 required">
                                                <label for="rice_convertion_ratio" class="form-control-label">Approx. Main Product Ratio</label>
                                                <input type="text" name="rice_convertion_ratio" id="rice_convertion_ratio" class="form-control">
                                            </div>
                                        </div> --}}
                                    </div>
