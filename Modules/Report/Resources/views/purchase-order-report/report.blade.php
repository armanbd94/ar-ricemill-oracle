                ...
                <table style="margin-bottom:10px !important;">
                    <tr>
                        <td class="text-center">
                            ...
                            font-weight: bold;background: black;border-radius: 10px;width: 250px;color: white;text-align: center;padding:5px 0;}">PURCHASE ORDER REPORT</p>
                            <p style="font-weight: normal;margin:0;font-weight:bold;">Date: {{ date('d-m-Y',strtotime($start_date)).' to '.date('d-m-Y',strtotime($end_date))  }}</p>
