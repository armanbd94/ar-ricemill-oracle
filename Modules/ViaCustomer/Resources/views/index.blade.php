        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    ...
                    <a href="javascript:void(0);" onclick="showNewFormModal('Add New Via Customer','Save')" class="btn btn-primary btn-sm font-weight-bolder"> 
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.textbox labelName="Via Customer Name" name="name" col="col-md-3" />
...
<script>
    ...
    $(document).ready(function(){
        ...
        table = $('#dataTable').DataTable({
            ...
            "ajax": {
                "url": "{{route('via.customer.datatable.data')}}",
                "type": "POST",
                "data": function (data) {
        ...
        $(document).on('click', '#save-btn', function () {
            ...
            let url = "{{route('via.customer.store.or.update')}}";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            $('#store_or_update_form #trade_name').val(data.trade_name);
        ...
        $(document).on('click', '.delete_data', function () {
            ...
            let url   = "{{ route('via.customer.delete') }}";
        ...
        function multi_delete(){
            ...
            if(ids.length == 0){
                ...
                let url = "{{route('via.customer.bulk.delete')}}";
        ...
        $(document).on('click', '.change_status', function () {
            ...
            let row    = table.row($(this).parent('tr'));
            let url    = "{{ route('via.customer.change.status') }}";
    ...
    function showNewFormModal(modal_title, btn_text) {
        ...
        $('#store_or_update_form').find('.is-invalid').removeClass('is-invalid');
        $('#store_or_update_form').find('.error').remove();
        $('#store_or_update_form #customer_id').val('');
        $('#store_or_update_form .selectpicker').selectpicker('refresh');
