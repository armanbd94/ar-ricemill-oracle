                ...
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <form action="" id="purchase_received_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <x-form.textbox labelName="Truck Fare" name="truck_fare" col="col-md-4"/>
                                ...
                                <table class="table table-bordered" id="material_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <input type="hidden" id="materials_1_received_unit_id" name="materials[1][received_unit_id]" data-row="1">
...
function store_data(){
    ...
    if (rownumber < 0) {
        ...
        let url = "{{route('purchase.received.store')}}";
        $.ajax({
            url: url,
            type: "POST",
            data: formData,
            ...
            success: function (data) {
                ...
                if (data.status == false) {
                    ...
                    if (data.status == 'success') {
                        window.location.replace("{{ url('purchase/received/view') }}/"+data.received_id);
