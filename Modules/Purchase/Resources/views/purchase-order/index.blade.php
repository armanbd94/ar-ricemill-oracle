        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    ...
                    <a href="{{ route('purchase.order.create') }}"  class="btn btn-primary btn-sm font-weight-bolder"> 
...
$(document).ready(function(){
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            "url": "{{route('purchase.order.datatable.data')}}",
            "type": "POST",
            "data": function (data) {
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        let url   = "{{ route('purchase.order.delete') }}";
    ...
    function multi_delete(){
        ...
        if(ids.length == 0){
            ...
            let url = "{{route('purchase.order.bulk.delete')}}";
