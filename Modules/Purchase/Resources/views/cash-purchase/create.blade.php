                ...
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <form action="" id="cash_purchase_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <x-form.textbox labelName="Receive Date" name="receive_date" value="{{ date('Y-m-d') }}" required="required" class="date" col="col-md-4"/>
                                ...
                                <table class="table table-bordered" id="material_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="text" style="width: 120px;" class="text-right form-control net_unit_cost" onkeyup="calculateRowTotal(1)" name="materials[1][net_unit_cost]" id="materials_1_net_unit_cost" data-row="1"></td>
