                ...
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    ...
                    <form id="transfer_inventory_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <x-form.selectbox labelName="Mix Item" name="material_id" required="required" class="selectpicker" col="col-md-3">
                                ...
                                <table class="table table-bordered" id="material_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width: 250px;"><input type="text" class="form-control" style="width: 250px;" name="materials[1][description]" id="materials_1_description" data-row="1"></td>                                    
                                            <td>
