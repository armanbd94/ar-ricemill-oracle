        ...
        <div class="card card-custom custom-card">
            <div class="card-header flex-wrap p-0">
                <div class="card-toolbar m-0">
                    <!--begin::Button-->
                    <a href="{{ route('build.re.process') }}" class="btn btn-warning btn-sm font-weight-bolder custom-btn">
            ...
            <div class="card-body">
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div class="row pb-5">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-4"><b>Packet Item</b></div>
                                <div class="col-md-8"><b>:</b> {{ $data->from_product->name }}</div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row">
